-- Meeting Integrations Database Schema
...
-- 10. Grant necessary permissions to service role (adjust as needed for your setup)
-- Note: These permissions should be reviewed and adjusted based on your security requirements
GRANT ALL ON user_meeting_integrations TO service_role;
GRANT ALL ON active_meeting_integrations TO service_role;
